    ...
    <>
      <footer className="footer bg-base-300 p-10 text-base-content">
        <div>
          ...
          <a className="link-hover link" href="https://discord.gg/WrzV6BvEQD">
            Discord
          </a>
          <a className="link-hover link" href="https://t.me/noboobs_ua">
            Telegram
          </a>
          <a
            className="link-hover link"
            href="https://www.instagram.com/no_boobs.ua"
          >
            Instagram
          </a>
        ...
        <div>
          ...
          <div className="grid grid-flow-col gap-4">
            <a href="https://t.me/noboobs_ua" target="_blank" rel="noreferrer">
              <TelegramIcon />
            </a>
            <a
